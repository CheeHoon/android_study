...
public class Ex22SQLiteExMain extends AppCompatActivity {

    LinearLayout frame1, frame2, frame3;

    //회원목록
    TextView tvMemberList1,tvMemberList2,tvMemberList3,tvMemberList4;
    //회원수정
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_ex22_sqlite_main);

        //데이베이스 생성.
        helper = new MySQLiteOpenHelper(
                Ex22SQLiteExMain.this, // 현재 화면의 context
                "member2.db", // 파일명
                null, // 커서 팩토리
                1); // 버전 번호

        //회원목록
        tvMemberList1 = (TextView)findViewById(R.id.tvMemberList1);
        tvMemberList2 = (TextView)findViewById(R.id.tvMemberList2);
        tvMemberList3 = (TextView)findViewById(R.id.tvMemberList3);
        tvMemberList4 = (TextView)findViewById(R.id.tvMemberList4);
        //회원수정
    ...
    public void selectAll() {
        ...
        tvMemberList1.setText(Result1);
        tvMemberList2.setText(Result2);
        tvMemberList3.setText(Result3);
        tvMemberList4.setText(Result4);
        c.close();
        db.close();
    }
