...
public class Ex17Viewpager2 extends AppCompatActivity {
    ...
    Button.OnClickListener mClickListener = new Button.OnClickListener() {
        ...
        switch (v.getId()){
            case R.id.ivRubtn:
                ivRuinv.setImageResource(R.drawable.ruiseinven);

                break;
            case R.id.ivDibtn:
                ivRuinv.setImageResource(R.drawable.daiiven);
                break;
            case R.id.ivCabtn:
                ivRuinv.setImageResource(R.drawable.carlinven);
                break;
            }
        }
    };
